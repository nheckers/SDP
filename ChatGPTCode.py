...
class FacialLoginSystem:
    ...
    def check_time_access(self, role):
        ...
        self.cursor.execute('''SELECT * FROM TimeRules WHERE role_name=? AND day=? AND ? >= start_time''', (role, current_day, current_time))
        return bool(self.cursor.fetchone())
    ...
    def detect_faces(self, frame):
        ...
        if face_locations:
            ...
            original_face_locations = [(top * 4, right * 4, bottom * 4, left * 4) for top, right, bottom, left in face_locations]
